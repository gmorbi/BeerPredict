...
namespace ConsoleApp1ML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\gemva\Desktop\POS\Machine_Learning\Trabalho\recipeData.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.StyleID} | Predicted value: {predictionResult.Prediction} | Predicted scores: [{String.Join(",", predictionResult.Score)}]");
